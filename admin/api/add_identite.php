...
/**
 * ============================================
 * API - AJOUTER UNE IDENTITÉ VISUELLE
 * ============================================
 * 
 * Endpoint pour ajouter une nouvelle identité visuelle dans le portfolio
 * 
...
$query = "INSERT INTO identites (client_name, date_realisation, image_path) 
...
if (mysqli_query($connect, $query)) {
    ...
    echo json_encode([
        'success' => true, 
        'message' => 'Identité visuelle ajoutée avec succès',
        'id' => $id
    ]);
} else {
    http_response_code(500);

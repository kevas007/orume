...
/**
 * ============================================
 * API - SUPPRIMER UNE IDENTITÉ VISUELLE
 * ============================================
 */
...
$query = "DELETE FROM identites WHERE id = $id";
...
if (mysqli_query($connect, $query)) {
    ...
    echo json_encode(['success' => true, 'message' => 'Identité visuelle supprimée avec succès']);
} else {
    http_response_code(500);

/**
 * ============================================
 * GESTION DE LA MODIFICATION D'UNE IDENTITÉ VISUELLE
 * ============================================
 * 
 * Ce script gère la modification d'une identité visuelle
 * depuis l'interface d'administration.
 * 
 * @file Modifier_identite.js
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    editForm.addEventListener("submit", function (e) {
        ...
        // Envoyer à l'API (vous devrez créer cette API)
        fetch('api/update_identite.php', {
            method: 'POST',
            body: formData
        })
        .then(res => res.json())
